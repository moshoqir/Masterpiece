    ...
    <div class="content-wrapper pb-4">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="text-white">Edit Session</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                            <li class="breadcrumb-item active text-white">Edit Session</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <form action="{{ route('TrainingSessions.update_session', [$trainingSession['id']]) }}" method="post"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" class="form-control"
                                        value="{{ $trainingSession->name }}" name="name">
                                    <label for="day">Day</label>
                                    <input type="date" id="day" class="form-control"
                                        value="{{ $trainingSession->day }}" name="day">
