            ...
            <div class="card card-purple card-outline w-25 m-auto">
                <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        ...
                        @role('user')
                            <li class="list-group-item">
                                <b>Subscription Starting Date</b> <a
                                    class="float-right">{{ auth()->user()->subscription_start }}</a>
                            </li>

                            <li class="list-group-item">
                                <b>Subscription Ending Date</b> <a
                                    class="float-right">{{ auth()->user()->subscription_end }}</a>
                            </li>
                        @endrole
                    </ul>

                    <a href="{{ route('user.edit_my_profile') }}" class="btn  btn-block"
